...
public class BookdailyBoosterAdapter extends RecyclerView.Adapter {
    ...
    private final int VIEW_TYPE_Ad = 2;
      public  int j;
    public BookdailyBoosterAdapter(Activity activity, List<CategoryList> categoryLists, int i, String type, OnClick onClick) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(activity).inflate(R.layout.item_daily_booster, parent, false);
