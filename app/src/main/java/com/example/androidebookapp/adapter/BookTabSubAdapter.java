...
public class BookTabSubAdapter extends RecyclerView.Adapter {
    ...
    public List<BookSubCategoryList> categoryListss;

    public ArrayList<BookSubCategoryList> bookSubCategoryList;
    private OnClick onClick;
    private BookTabSubAdapter categoryAdapter;
    ...
    public BookTabSubAdapter(Activity activity, List<BookSubCategoryList> bookSubCategoryList, String type) {
        this.activity = activity;
        this.type = type;
        this.bookSubCategoryList = (ArrayList<BookSubCategoryList>) bookSubCategoryList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(activity).inflate(R.layout.category_adapterr, parent, false);
