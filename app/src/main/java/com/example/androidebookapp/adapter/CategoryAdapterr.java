...
public class CategoryAdapterr extends RecyclerView.Adapter {

    private Method method;
    private Activity activity;
    private String type;
    private int columnWidth;
    private List<BookSubCategoryList> categoryLists;
    ...
    public CategoryAdapterr(Activity activity, List<BookSubCategoryList> my_id_dataArrayList, String type) {
        this.activity = activity;
        this.type = type;
        this.categoryLists = my_id_dataArrayList;
