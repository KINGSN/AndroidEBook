...
public class BookHomecatAdapter extends RecyclerView.Adapter<BookHomecatAdapter.ViewHolder> {
    ...
    public BookHomecatAdapter(Activity activity, List<SubCategoryList> subCategoryLists, String type, OnClick onClick) {
    ...
    public ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(activity).inflate(R.layout.book_subcategory_adapter, parent, false);
