...
import com.example.androidebookapp.databinding.ActivityPlayBinding;
...
public class QuizQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(QuizQuestionActivity.this, R.layout.activity_play);
        method = new Method(QuizQuestionActivity.this, onClick);
