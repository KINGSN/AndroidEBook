...
import com.example.androidebookapp.adapter.HomeCatAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        seekBar3=view.findViewById(R.id.seek_bar3);
        seekBar4=view.findViewById(R.id.seek_bar4);
        ...
        tvPercent4=view.findViewById(R.id.tv_percent4);
                        ...
                        try {
                            ...
                            if (homeRP.getStatus().equals("1")) {
                                ...
                                if (homeRP.getCategoryLists().size() != 0) {
                                    ...
                                    GlobalVariables.categoryLists= homeRP.getCategoryLists();
    ...
    private void calculatePecent() {
        ...
        Log.d("KINGSN", "onResponse2: "+GlobalVariables.categoryLists.get(0).getCategory_name().toString());
