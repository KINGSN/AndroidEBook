...
public class GlobalVariables {
    ...
    public static final String APP_NAME = "GpuntDAdmin";
    ...
    public static final String Txn_amount= "txnAm";
    public static final String Txn_type= "txnType";
    public static final String Txn_status= "txnStatus";

    public static final String AppContact= "AppContact";
    ...
    public static final String USER1DTO = "user_1dto";
    public static final String TAG = "abcdapp";
    public static String SELUSER_MOBILE = "SELUSER_MOBILE";
    public static String SELUSER_NAME = "SELUSER_NAME";
    public static String SELUSER_REGDATE = "SELUSER_REGDATE";
    public static String SELUSER_ACTIVE = "SELUSER_ACTIVE";
    public static String SELUSER_WALLETBAL = "SELUSER_WALLETBAL";
    public static String SELUSER_REFERCODE = "userPhone";
    public static final String USER_PASSWORD = "SELUSER_REFERCODE";
 ...
 /*   public static Settings settings;
    ...
    public static String offerType="add";
    public static  HomeGraphDTO homeGraph;
    public static HomeTopUserDTO homeTopUserDTO;
    public static HomeTopDepositsDTO homeTopDepositsDTO;*/
    ...
    public static String screentype="0";
    public static String IMAGE_URI_CAMERA = "image_uri_camera";
    public static final String IMAGE = "image";
    public static final String btntxt = "Go to Home";
    public static final String selectUser = "Select User To Chat";
    public static final String UpdateKyc = "Update Kyc";
    public static final String update="UPDATE";
    public static final String blocked="CONTACT ADMIN";
    public static String directMyid = "0";
    public static String HowToUseUrl="https://newpunt.com/contact";




    //public static newpunt.v1infotech.com.qrcode.Models.AdModelCount AdModelCount;
    //public static AdModelCount adModelCount;
    /*public static AboutUsList aboutUsList;
    public static InterstitialAdModelCount interstitialAdModelCount;
    public static AdClickModel adClickModel;
*/


    /*Notifications Codes*/
    public static  String DECLINE_BOOKING_ARTIST_NOTIFICATION = "10002";//both
    public static  String START_BOOKING_ARTIST_NOTIFICATION = "10003";
    public static  String END_BOOKING_ARTIST_NOTIFICATION = "10004";//user
    public static  String CANCEL_BOOKING_ARTIST_NOTIFICATION = "10005";
    public static  String ACCEPT_BOOKING_ARTIST_NOTIFICATION = "10006";//user
    public static  String CHAT_NOTIFICATION = "10007";//both
    public static  String ALL_DEPOSIT = "10001";//both
    public static  String USER_PASSID = "10003";//both
    public static  String USER_WITHDRAWALS = "10018";
    public static  String TICKET_COMMENT_NOTIFICATION = "10009";//both
    public static  String WALLET_NOTIFICATION = "10010";//both
    public static  String JOB_NOTIFICATION = "10011";//ar
    public static  String JOB_APPLY_NOTIFICATION = "10012";//user
    public static  String DELETE_JOB_NOTIFICATION = "10013";//ar
    public static  String BRODCAST_NOTIFICATION = "10014";//both
    public static  String TICKET_STATUS_NOTIFICATION = "10015";//both
    ...
    //public static final String QUIZ_URL = "https://cdn.images.express.co.uk/img/dynamic/130/590x/Easy-quiz-questions-1282929.jpg?r=1591453088068";
    //public static final String SPIN_URL = "https://i.dlpng.com/static/png/6574939_preview.png";
    // public static final String NEWS_URL = "https://newsapi.org/v2/top-headlines?country=us&apiKey=6878076e8fbe44e892814490bde6ba92";
    //public static final String TASK_URL = "https://cdn.searchenginejournal.com/wp-content/uploads/2018/03/4-things-seos-should-do-760x400.png";



    public static  String userMobile = "userMobile";
    public static  String userMobile1 = "userMobile";
    ...
    public static String sendTo = "adminMobile";
    public static String sendBy = "userMobile";
    ...
    public static String VOICE_PREFERENCE = "voice_preference";
    public static String VOICE_PREFERENCE_ENGLISH = "en";
    public static  String VOICE_PREFERENCE_ARABIC = "ar";
